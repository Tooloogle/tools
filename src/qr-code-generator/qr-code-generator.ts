...
export class QrCodeGenerator extends WebComponentBase<IConfigBase> {
    ...
    qrCode: QRCodeStyling = isBrowser() ? new QRCodeStyling({ ...QrStyleList[2].qrCfg, width: 300, height: 300 }) : {} as QRCodeStyling;
    ...
    @property() downloadExt: Extension = "jpeg";
        ...
        <div class="qr-code-generator">
            <div class="grid grid-cols-1 gap-4">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <button class="btn btn-red btn-sm btn-remove" @click=${this.removeLogo}>Remove logo</button>
                </div>
