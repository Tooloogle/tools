...
export class MarkdownToHtmlConverter extends WebComponentBase<IConfigBase> {
    static override styles = [WebComponentBase.styles, inputStyles, markdownToHtmlConverterStyles];
    ...
    private process() {
        ...
        try {
            ...
            this.errorMessage = `Error: ${error instanceof Error ? error.message : 'Failed to convert Markdown'}`;
            this.outputText = '';
        }
    }
        ...
        return html`
            <div class="space-y-4">
                ...
                <div class="text-sm text-gray-600">
                    Converts Markdown syntax to HTML using the marked library. Supports headings, lists, bold, italic, links, and more.
                </div>
            </div>
        `;
    }
