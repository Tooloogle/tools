...
export class ImageResizer extends WebComponentBase<IConfigBase> {
    static override styles = [WebComponentBase.styles, inputStyles, imageResizerStyles];
    ...
    private process() {
        // TODO: [Browser] Image resizing requires canvas API
        this.outputText = 'Image resizing requires canvas rendering';
    }
