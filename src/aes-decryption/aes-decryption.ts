...
export class AesDecryption extends WebComponentBase<IConfigBase> {
    ...
    private process() {
        // TODO: [Server] AES decryption with proper key management should be server-side
        this.outputText = 'AES decryption requires server-side implementation with secure key management';
    }
