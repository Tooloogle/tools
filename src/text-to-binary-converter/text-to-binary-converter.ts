...
export class TextToBinaryConverter extends WebComponentBase<IConfigBase> {
    static override styles = [WebComponentBase.styles, inputStyles, textToBinaryConverterStyles];
        ...
        return html`
            <div class="space-y-4">
                ...
                <div>
                    ...
                    ></textarea>
                    ${this.outputBinary ? html`<t-copy-button .text=${this.outputBinary}></t-copy-button>` : ''}
                </div>
            </div>
        `;
    }
