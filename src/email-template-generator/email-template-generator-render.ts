...
export class EmailTemplateRender {
      ...
      <div class="row">
        <div class="input-group">
          ...
          <select class="form-input" @change="${handleTemplateChange}">
            ...
            <option value="newsletter" ?selected="${templateType === "newsletter"}">
              Newsletter
            </option>
            <option value="promotional" ?selected="${templateType === "promotional"}">
              Promotional
            </option>
            <option value="notification" ?selected="${templateType === "notification"}">
              Notification
            </option>
            <option value="invitation" ?selected="${templateType === "invitation"}">
              Invitation
            </option>
          </select>
        </div>
    ...
    static renderBasicSettings(
      ...
      <div class="row">
        ...
        <div class="input-group">
          ...
          <input type="color" class="form-input color-input" name="companyColor"
            .value="${companyColor}"
            @input="${handleInputChange}"
          />
        </div>
    ...
    static renderCtaSettings(
      ...
      <div class="row">
        <div class="input-group">
          ...
          <input type="text" class="form-input" name="ctaText"
            .value="${ctaText}"
            @input="${handleInputChange}"
          />
        </div>
        ...
        <div class="input-group">
          ...
          <input type="url" class="form-input" name="ctaUrl"
            .value="${ctaUrl}"
            @input="${handleInputChange}"
          />
        </div>
    ...
    static renderContentSettings(
      ...
      <div>
        ...
        <textarea class="form-input content-textarea"
          placeholder="Paste your HTML content here, or leave empty to use template default. Use [Company], [Name] as placeholders."
          @input="${handleTextareaChange}"
          .value="${customContent}"></textarea>
        <small class="help-text">You can paste HTML directly here. Use &lt;p&gt;, &lt;h3&gt;,
          &lt;ul&gt;&lt;li&gt;, &lt;strong&gt;, &lt;em&gt; tags as needed.</small
        >
      </div>
    `;
    }
      ...
      <div>
        ...
        <div class="row">
          <div class="input-group">
            ...
            <input type="text" class="form-input" name="eventDate"
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-input" name="eventTime"
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-input" name="eventLocation" placeholder="e.g., Conference Center, 123 Main St"
              .value="${eventLocation}"
              @input="${handleInputChange}"
            />
          </div>
    ...
    static renderFooterSettings(
      ...
      <div>
        ...
        <textarea class="form-input footer-textarea" name="footerText" @input="${handleInputChange}" .value="${footerText}"></textarea>
      </div>
      ...
      <div class="footer-section">
        ...
        <div>
          <label>
            <input type="checkbox" name="includeUnsubscribe" .checked="${includeUnsubscribe}" @change="${handleInputChange}"/>
        ...
        <div>
          <label>
            <input type="checkbox" name="includePrivacyPolicy" .checked="${includePrivacyPolicy}" @change="${handleInputChange}"/>
            Include Privacy Policy Link
          </label>
          ${includePrivacyPolicy
                ? html`
                <input type="url" class="form-input" name="privacyPolicyUrl" placeholder="Privacy Policy URL" .value="${privacyPolicyUrl}" @input="$ handleInputChange}"/>
              `
                : ""}
        </div>
        ...
        <div>
          <label>
            <input type="checkbox" name="includeTermsConditions" .checked="${includeTermsConditions}" @change="${handleInputChange}" />
            Include Terms &amp; Conditions Link
          </label>
          ${includeTermsConditions
                ? html`
                <input type="url" class="form-input" name="termsConditionsUrl" placeholder="Terms &amp; Conditions URL"
    ...
    static renderOutput(generatedHtml: string): TemplateResult {
      ...
      <div class="output-section">
        ...
        <textarea class="form-input html-output" readonly .value="${generatedHtml}"></textarea>
      </div>
