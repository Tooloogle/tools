...
export class CssBoxShadowGenerator extends WebComponentBase<IConfigBase> {
    static override styles = [WebComponentBase.styles, inputStyles, cssBoxShadowGeneratorStyles];
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" class="form-input w-full" .value=${String(this.blurRadius)}
                    ...
                    <div>
                        ...
                        <input type="number" class="form-input w-full" .value=${String(this.spreadRadius)}
                            @input=${(e: Event) => { this.spreadRadius = Number((e.target as HTMLInputElement).value); this.process(); }} />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="range" min="0" max="1" step="0.1" class="w-full" .value=${String(this.opacity)}
                            @input=${(e: Event) => { this.opacity = Number((e.target as HTMLInputElement).value); this.process(); }} />
