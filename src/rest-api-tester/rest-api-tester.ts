...
export class RestApiTester extends WebComponentBase<IConfigBase> {
    static override styles = [WebComponentBase.styles, inputStyles, restApiTesterStyles];
    ...
    private process() {
        // TODO: [Browser] API testing requires fetch/CORS support
        this.outputText = 'REST API testing requires fetch API and CORS configuration';
    }
