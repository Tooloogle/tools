    ...
    return html`
      <div class="space-y-4">
        <div>
          ...
          <t-input type="password" placeholder="Enter secret key for encryption..." class="w-full"></t-input>
        ...
        <div>
          ...
          <t-textarea placeholder="Enter text to encrypt..." class="w-full h-32"></t-textarea>
        </div>
        ${this.error
