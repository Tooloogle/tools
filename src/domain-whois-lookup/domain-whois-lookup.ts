...
export class DomainWhoisLookup extends WebComponentBase<IConfigBase> {
    static override styles = [WebComponentBase.styles, inputStyles, domainWhoisLookupStyles];
    ...
    private process() {
        // TODO: [Server/API] WHOIS lookups require server-side WHOIS protocol
        this.outputText = 'WHOIS lookup requires server-side WHOIS query capability';
    }
