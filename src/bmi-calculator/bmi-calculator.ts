    ...
    private renderResults() {
        return html`
            <div class="result-container">
                <div class="bmi-value">BMI: <span style="color: ${getCategoryColor(this.category)}"> ${this.bmi}</span></div>
                <div class="category-display">
                    Category: <span style="color: ${getCategoryColor(this.category)}">${this.category}</span>
                </div>
            </div>
        `;
    }
    ...
    override render() {
        return html`
            <div class="container">
                ...
                ${this.bmi > 0 && !this.hasErrors ? html`
                    ${this.renderResults()}
