...
export class PomodoroTimer extends WebComponentBase<IConfigBase> {
    static override styles = [WebComponentBase.styles, inputStyles, pomodoroTimerStyles];
    ...
    private process() {
        // TODO: [Implementation] Pomodoro timer (25min work, 5min break)
        ...
        return html`
            <div class="space-y-4">
                ...
                <div class="text-sm text-gray-600">
                    Note: Pomodoro timer (25min work, 5min break)
                </div>
            </div>
        `;
    }
