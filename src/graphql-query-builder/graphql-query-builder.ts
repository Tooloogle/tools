...
export class GraphqlQueryBuilder extends WebComponentBase<IConfigBase> {
    static override styles = [WebComponentBase.styles, inputStyles, graphqlQueryBuilderStyles];
    ...
    private process() {
        // TODO: [Implementation] Build GraphQL queries
