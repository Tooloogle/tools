...
export class ExcelToJsonConverter extends WebComponentBase<IConfigBase> {
    static override styles = [WebComponentBase.styles, inputStyles, excelToJsonConverterStyles];
    ...
    private process() {
        // TODO: [Package] Excel parsing requires library (e.g., xlsx, sheetjs)
        this.outputText = 'Excel parsing requires xlsx library';
    }
