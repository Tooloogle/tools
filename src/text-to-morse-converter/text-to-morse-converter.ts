...
export class TextToMorseConverter extends WebComponentBase<IConfigBase> {
    static override styles = [WebComponentBase.styles, inputStyles, textToMorseConverterStyles];
        ...
        return html`
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea
                        class="form-input w-full h-32 font-mono text-lg"
                        readonly
                        .value=${this.outputMorse}
                    ></textarea>
                    ${this.outputMorse ? html`<t-copy-button .text=${this.outputMorse}></t-copy-button>` : ''}
                </div>
            </div>
        `;
    }
